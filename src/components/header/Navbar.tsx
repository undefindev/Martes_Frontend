            ...
            <div className="flex h-16 items-center justify-between">
              ...
              <div className="hidden md:block">
                <div className="ml-4 flex items-center md:ml-6">
                  <button
                    type="button"
                    className="relative rounded-full p-1 text-gray-400 hover:text-cyan-400 focus:outline-none focus:ring-1 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-cyan-400"
                  >
  ...
  return (
    <>
      ...
      <div className="min-h-full">
        ...
        aqui empiez la pagina principal
