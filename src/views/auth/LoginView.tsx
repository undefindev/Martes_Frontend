  ...
  return (
    <>
      <form
        ...
        className="bg-slate-100 shadow-lg rounded-2xl md:max-w-96 px-12 pt-12 pb-6 mx-4 md:mx-0"
        noValidate
      >
          ...
          <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7 pb-0">
            <div className="relative">
              <input
                ...
                className="bg-slate-100 peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-indigo-400"
                {...register("email", {
              ...
              />
              <label className="absolute left-0 -top-3.5 text-gray-500 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-indigo-500 peer-focus:text-sm">email</label>
              {errors.email && (
